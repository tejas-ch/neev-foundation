...
const premiumCourses: Course[] = [
  ...
  },
  {
    ...
    subtitle: "Your Gateway to IIT Success",
    ...
    features: ["IIT Alumni Faculty", "Weekly Tests", "Doubt Clearing Sessions", "Online Test Series"],
  ...
  },
  {
    ...
    features: ["Medical Faculty", "Clinical Examples", "Lab Sessions", "AIIMS Preparation"],
    icon: "FaMicroscope",
    difficulty: "Advanced",
    price: "₹75,000",
