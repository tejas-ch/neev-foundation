...
const premiumCourses: Course[] = [
  ...
  },
  {
    ...
    description: "Comprehensive 2-year program designed for engineering entrance exams with proven methodology and expert guidance.",
    duration: "2 Years",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="container-custom">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-navy-900 to-gold-600 bg-clip-text text-transparent mb-6">
